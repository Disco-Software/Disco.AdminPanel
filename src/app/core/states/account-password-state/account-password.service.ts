...
export class AccountPasswordService {
  ...
  public forgotPassword(forgotPasswordModel : ForgotPasswordRequestModel, description: string) : Observable<void> {
    return this._restService.request('POST', 'admin/account/password/forgot', description, forgotPasswordModel);
  }
